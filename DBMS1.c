/*reviewing, re-writting and testing code to be clean based on our project needs with open source project 
on github that are somehow related to our project like  github.com/koalaChelsea , also through using some helpful books like C notes for professional 
on internet*/
